...
### Database
- [ ] No migration required — `CandleRow` already has `timeframe` as part of the primary key
- [ ] Verify existing index `(symbol, timeframe, usage)` covers new query patterns
